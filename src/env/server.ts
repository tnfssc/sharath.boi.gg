...
const ServerEnvArk = type({
  ...
  LIBSQL_URL: "string",
  MD_TO_HTML_API_KEY: "string",
  MD_TO_HTML_ENDPOINT: "string.url",
  OUTLINE_API_BASE: "string.url",
...
export const serverEnv = ServerEnvArk.assert({
  ...
  MD_TO_HTML_API_KEY: process.env.MD_TO_HTML_API_KEY,
  MD_TO_HTML_ENDPOINT: process.env.MD_TO_HTML_ENDPOINT,
  OUTLINE_API_BASE: process.env.OUTLINE_API_BASE,
